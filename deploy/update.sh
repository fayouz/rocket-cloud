#!/bin/sh
# Updates a Rocket Cloud installed without Docker (git clone of the repository), in place:
...
#   UPDATE_RESTART_COMMAND   command restarting the services, e.g. "sudo systemctl restart rocket-cloud-front"
...
step "Rocket Cloud: $(git describe --tags --always 2>/dev/null || echo unknown) in $ROOT"
...
step "Rocket Cloud $VERSION installed"
